...
(function (root, factory) {
  ...
  var Player = function(parOptions){
    ...
    //console.log("this.createCanvasObj=", this.createCanvasObj);
    
    
    var lastWidth;
    var lastHeight;
    var onPictureDecoded = function(buffer, width, height, infos) {
      //console.log('Player.onPictureDecoded', buffer, width, height, infos);
    ...
    if (this._config.useWorker){
      ...
      this.decode = function(parData, parInfo){
        //console.log("Player.decode:", parData, parInfo);
  ...
  Player.prototype = {
    ...
    renderFrameWebGL: function(options){
      //console.log("renderFrameWebGL", options);
    ...
    renderFrameRGB: function(options){
      //console.log("renderFrameRGB", options);
      var canvasObj = options.canvasObj;
      ...
      //console.log("putImageData", imgData);
